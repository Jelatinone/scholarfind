...
public record SignalPattern(
  ...
  public static final SignalPattern AGGRESIVE = new SignalPattern(0, 1D, 0, 1D, 4D, 0, 1D, 2D, 4D);
  public static final SignalPattern DEFAULT = new SignalPattern(0, 1D, 0, 1D, 4D, 0, 1D, 2D, 4D);
  public static final SignalPattern CONSERVATIVE = new SignalPattern(0, 1D, 0, 1D, 4D, 0, 1D, 2D, 4D);
}
