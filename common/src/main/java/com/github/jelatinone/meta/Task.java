...
import com.github.jelatinone.meta.archetype.Archetype;
...
public sealed abstract class Task<@NonNull State, @NonNull Consumes, @NonNull Produces>
    implements Runnable, Archetype<Consumes, Produces>
   ...
   * 
   */
  protected abstract void useState(final @NonNull State state);
}
