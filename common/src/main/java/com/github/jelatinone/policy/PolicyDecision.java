...
public record PolicyDecision<State>(
  ...
  public static <State> PolicyDecision<State> drop(State state, ReasonCode reasonCode, String reasonDetail) {
  ...
  public static <State> PolicyDecision<State> error(State state, ReasonCode reasonCode, String reasonDetail) {
